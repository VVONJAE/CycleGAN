...
def get_args():
    ...
    parser.add_argument('--decay_epoch', type=int, default=100) #default=100
    ...
    parser.add_argument('--dataset_dir', type=str, default='./DataSet/face')
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoints/face')
